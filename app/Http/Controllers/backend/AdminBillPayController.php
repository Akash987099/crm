...
class AdminBillPayController extends Controller
{
    public function Bill_payment_Bde($id)
    {
        ...
        return view('backend.billpay.bill-pay', compact('meeting_data', 'payment_details'));
    }
    ...
    public function Add_payment_Bde(Request $request)
    {
        ...
        $meet_data = Meeting::find(Crypt::decrypt($request->meetingid));
