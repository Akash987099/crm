        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="m-2">
                    ...
                    <table id="dtBasicExample" class="table table-bordered dataTable" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Designation</th>
              ...
              <input type="hidden" id="updateid" name="updateid" value="">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group m-2">
                            <label>Designation <span class="text-danger">*</span></label>
                            <input type="text" name="Designation" id="Designation" class="form-control" value="{{old('Designation')}}" placeholder="Designation" required>
                            <span class="text_error" id="Designation_error">@error('firstname') {{$message}} @enderror</span>
                        </div>
                    </div>
                </div>
