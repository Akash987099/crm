...
<div class="pagetitle">
    <div class="row">
        ...
        <div class="col-lg-3">
            <nav>
                <ol class="breadcrumb">
                    <li class="p-1"><a class="btn btn-primary btn-sm text-white" href="{{route('add-employee')}}"><i class="bi bi-plus-circle"></i> Add</a></li>
                    <li class="p-1"><a class="btn btn-danger btn-sm text-white" href="{{route('employee')}}"><i class="bi bi-list"></i> view</a></li>
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('archiveemployeeview') }}",
