        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body pb-0 m-4">
                    ...
                    <form method="post" action="{{route('addagents')}}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="empl" value="1">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group m-2">
                                    ...
                                    <input type="number" maxlength="10" name="contact" class="form-control" value="{{old('contact')}}" placeholder="contact">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group m-2">
                                    ...
                                    <input type="text" id="District" name="District" class="form-control" value="{{old('District')}}" placeholder="District">
 ...
 <div class="col-lg-6">
                             ...
                             <div class="col-lg-6">
                              ...
                              <div class="col-lg-6">
                                <div class="form-group m-2">
                                    ...
                                    <input type="number" name="aadharcardno" class="form-control" value="{{old('aadharcardno')}}" placeholder="Aadhar Card Number">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group m-2">
                                    ...
                                    <input type="number" name="Payment" class="form-control" value="{{old('Payment')}}" placeholder="Payment">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group m-2">
                                    ...
                                    <input type="number" name="Due" class="form-control" value="{{old('Due')}}" placeholder="Due">
