...
<div class="row">
    ...
    <div class="col-lg-4">
        <nav>
            <ol class="breadcrumb">
                <li><a class="btn btn-danger text-white" href="{{route('backend.view-meeeting')}}"><i class="bi bi-arrow-left"></i> Attend Meeting</a></li>
                &nbsp;
                <li><a class="btn btn-danger text-white" href="{{route('backend.view-cold-call')}}"><i class="bi bi-arrow-left"></i> Cold Call</a></li>
            </ol>
        </nav>
    </div>
</div>
<section class="section profile">
    ...
    <div id="showPayment" class="card">
        <div class="card-body">
            ...
            @endif
            <form method="post" action="{{route('backend.add-mpayment',['meetingid'=>Crypt::encrypt($meeting_data->id)])}}">
                @csrf
                <div class="row">
                    <div class="col-md-3">
