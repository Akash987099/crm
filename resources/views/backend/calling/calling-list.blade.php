...
<div class="pagetitle">
    <div class="row">
        ...
        <div class="col-lg-3">
            <nav>
                <ol class="breadcrumb">
                    <li class="p-1"><a class="btn btn-primary text-white" href="{{route('backend.addcall')}}"><i class="bi bi-plus-circle"></i> Add Call</a></li>
                    <li class="p-1"><a class="btn btn-danger text-white" href="{{route('backend.archive-calling')}}"><i class="bi bi-archive"></i> Archive Call</a></li>
                </ol>
            </nav>
        </div>
    </div>
