                                ...
                                <tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$count++}}</td>
                                            @if ($file->is_folder)
                                            <td><a href="{{ route('admin_file', ['parentId' => $file->id]) }}">{{ $file->name }}</a></td>
                                        @else
                                        ...
                                        <td>
                                            <div class="d-inline-block">
                                                ...
                                                <a class="btn btn-danger btn-sm" href="{{ route('file_view', ['id' => $file->staff_id]) }}">View</a>
                                            </div>
                                            <div class="d-inline-block">
                                                <button type="button" class="btn btn-danger btn-sm uploaddocument" data-id="{{$file->staff_id}}" id="">Upload</button>
                                            </div>
                                            <div class="d-inline-block ml-2">
                                                <form action="{{ route('file.deleteFile', ['id' => $file->id]) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('file.createFolder') }}" method="POST">
                                            @csrf
