...
<div class="pagetitle">
    <div class="row">
        ...
        <div class="col-lg-3">
            <nav>
                <ol class="breadcrumb">
                    <li><a class="btn btn-primary btn-sm text-white" href="{{route('leadclient')}}"><i class="bi bi-plus-circle"></i> Add Lead</a></li>
                    &nbsp;
