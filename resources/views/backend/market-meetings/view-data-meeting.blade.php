...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-10">
            <h1><i class="bi bi-person"></i>@if(isset($user->firstname) && isset($user->lastname)) {{$user->firstname.' '.$user->lastname}} @endif</h1>
        </div>
        <div class="col-lg-2">
            <nav>
                <ol class="breadcrumb">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-sm-6 lh-lg">
                            <div>
                                Which team has given the meeting :
                                @if(isset($given_meeting_user->firstname) && $given_meeting_user->lastname)
                                <span class="text-danger">{{$given_meeting_user->firstname.' '.$given_meeting_user->lastname}}</span>
                                @endif
                            </div>
                    ...
                    <div class="table-responsive-sm">
                        ...
                        <table class="table table-striped">
                            ...
                            <tfoot>
                                <tr>
                                    <th>Sub Total</th>
                                    <th>@if(isset($amount)){{number_format($amount, 2, '.', ',')}}@endif</th>
                                </tr>
                            </tfoot>
                        </table>
                        @endif
