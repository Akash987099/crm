...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-10">
            <h1><i class="bi bi-card-list"></i> Archive Assign Meetings </h1>
            <h1><i class="bi bi-person"></i> {{$user->firstname.' '.$user->lastname}}</h1>
        </div>
        <div class="col-lg-2">
            <nav>
                <ol class="breadcrumb">
                    <li><a class="btn btn-danger text-white" href="{{route('backend.telemarket.view-telemarketing')}}"><i class="bi bi-arrow-left"></i> Back</a></li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <table class="table dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm text-danger m-1" href="{{route('backend.telemarket.assign-meeting-active', ['id' => Crypt::encrypt($row_data->id)])}}"> <i class="bi bi-arrow-clockwise"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
