...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-10">
            <h1><i class="bi bi-check-circle-fill"></i> Cold Call Report</h1>
        </div>
        <div class="col-lg-2">
            <nav>
                <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body pb-0 m-4">
                    ...
                    <form method="post" action="{{route('backend.filter-coldcall')}}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-3">
            ...
            <div class="card">
                <div class="m-2">
                    <table id="myTable" class="table dataTable" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
...
<script>
    $(document).ready(function() {
        $("#user_type").change(function() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{url('admin/filter-coldcall-data')}}",
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": dataid
                },
