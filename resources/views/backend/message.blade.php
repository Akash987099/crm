...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-9">
            <h1><i class="bi bi-card-list"></i> Designation </h1>
        </div>
        <div class="col-lg-3">
            <nav>
                <ol class="breadcrumb">
...
<div class="modal fade" id="basicModal" tabindex="-1">
  ...
  <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Add Messages</h5>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group m-2">
                            ...
                            <textarea name="message" id="programeditor" cols="30" rows="10"></textarea>
                            <span class="text_error" id="message_error">@error('message') {{$message}} @enderror</span>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(document).on('click', '#save', function() {
        // Get CKEditor data
        const message = editorInstance.getData();

        // Add CKEditor data to form data
