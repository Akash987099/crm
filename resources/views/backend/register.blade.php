                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" method="post" action="{{url('admin/signup')}}">
                                        @csrf
                                        <div class="col-12">
                                            <label class="form-label">Your Name</label>
                                            <input type="text" name="name" class="form-control">
                                            <div class="small text-danger">@error('name') {{$message}} @enderror</div>
                                        </div>
                            ...
                            <div class="credits">
                                Powered by <a href="https://magnumdigitalsolution.com">Arya web coding</a>
                            </div>
