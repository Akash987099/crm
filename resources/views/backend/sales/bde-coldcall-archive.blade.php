                    ...
                    <table class="table dataTable table-responsive" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a title="Active" class="btn btn-info btn-sm text-danger" href="{{route('backend.bde-coldcall-active',['meetingid'=>Crypt::encrypt($row_value->id)])}}"> <i class="bi bi-arrow-clockwise"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
