...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-10">
            <h1><i class="bi bi-person"></i>@if(isset($user->bde_name)) {{$user->bde_name}} @endif</h1>
        </div>
        <div class="col-lg-2">
            <nav>
                <ol class="breadcrumb">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6 lh-lg">
                            <div class="text-danger">
                                ...
                                <span class="text-success">{{$given_meeting_user->firstname.' '.$given_meeting_user->lastname}}</span>
                                @endif
                            </div>
                                ...
                                <table class="table table-responsive" cellspacing="0" width="100%">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">@if(isset($row->due_amount)){{($row->due_amount)}}@endif</td>
                                            <td colspan="2"></td>
                                        </tr>
                                    </tfoot>
