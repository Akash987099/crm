...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-10">
            <h1><i class="bi bi-archive text-danger"></i> Archive Manager Meetings</h1>
            <nav>
                <ol class="breadcrumb">
                    <li><a><i class="bi bi-person"></i> {{$user->name}} (Manager)</a></li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-2">
                    ...
                    <table class="table dataTable table-responsive" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a title="Active" class="btn btn-info btn-sm text-danger" href="{{route('backend.manager.manager-meetings-active', ['id' => Crypt::encrypt($row_value->id)])}}"> <i class="bi bi-arrow-clockwise"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
