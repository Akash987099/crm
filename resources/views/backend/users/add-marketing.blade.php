...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-9">
            <h1>Add Marketing User</h1>
        </div>
        <div class="col-lg-3">
            <nav>
                <ol class="breadcrumb">
                    <li class="p-1"><a class="btn btn-primary btn-sm text-white" href="{{url('admin/marketing')}}"><i class="bi bi-list"></i> View User</a></li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body pb-0 m-4">
                    ...
                    <form method="post" action="{{url('admin/add-marketing')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
