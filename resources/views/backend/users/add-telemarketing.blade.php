...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-9">
            <h1><i class="bi bi-plus-circle-fill"></i> Add Telemarketing User</h1>
        </div>
        <div class="col-lg-3">
            <nav>
                <ol class="breadcrumb">
                    <li class="p-1"><a class="btn btn-primary btn-sm text-white" href="{{url('admin/telemarketing')}}"><i class="bi bi-list"></i> View User</a></li>
                    <li class="p-1"><a class="btn btn-danger btn-sm text-white" href="{{url('admin/archive-telemarketing')}}"><i class="bi bi-archive"></i> Archive User</a></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body pb-0 m-4">
                    ...
                    <form method="post" action="{{url('admin/add-telemarketing')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
