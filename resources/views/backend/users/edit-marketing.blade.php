...
<div class="pagetitle">
    <div class="row">
        ...
        <div class="col-lg-3">
            <nav>
                <ol class="breadcrumb">
                    <li class="p-1"><a class="btn btn-danger btn-sm text-white" href="{{url('admin/marketing')}}"> <i class="bi bi-arrow-left"></i> back</a></li>
                    <li class="p-1"><a class="btn btn-danger btn-sm text-white" href="{{url('admin/archive-marketing')}}"><i class="bi bi-archive"></i> Archive User</a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<section class="section dashboard">
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body pb-0 m-4">
                    ...
                    <form method="post" action="{{url('admin/edit-marketing')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
        ...
        <div class="col-lg-4">
            <div class="card">
                <form method="post" action="{{url('admin/marketing-pass')}}">
                    @csrf
