    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tele Marketing User Information</h5>
...
<script>
    $(function() {
        ...
        var table = $('.dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('backend.telemarket.view-telemarketing') }}",
    ...
    $(document).on('click', '.telemarketing', function() {
        var dataId = $(this).attr("data-id");
        $.ajax({
            type: 'POST',
            url: "{{url('admin/view-details-telemarketing')}}",
            data: {
                "_token": "{{ csrf_token() }}",
                "id": dataId
            },
