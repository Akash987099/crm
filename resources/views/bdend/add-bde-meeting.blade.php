...
<div class="row">
    ...
    <div class="col-lg-3">
        <nav>
            <ol class="breadcrumb">
                <li class="p-1"><a class="btn btn-primary btn-sm text-white" href="{{url('bde/view-bde-meeting')}}">
                        <i class="bi bi-card-list"></i> View Meeting
                    </a>
                </li>
                <li class="p-1"><a class="btn btn-danger btn-sm text-white" href="">
                ...
                <div class="card-body pt-2">
                    <div class="tab-content pt-2">
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            @endif
                            <div class="msg"></div>
                            <form method="post" action="{{url('bde/add-bde-meeting')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-4">
...
<script>
    $(document).ready(function() {
        ...
        $(".services").change(function() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{url('bde/service-select-getprice')}}",
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": getId
                },
...
<script>
    ...
    $(".client_id").on('change', function() {
        ...
        $.ajax({
            type: 'post',
            url: "{{url('bde/clientselectgetcompany')}}",
            data: {
                "_token": "{{ csrf_token() }}",
                "id": getId
            },
