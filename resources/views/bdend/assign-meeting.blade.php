...
<div class="row">
    <div class="col-lg-10">
        <div class="pagetitle">
            <h1><i class="bi bi-pencil-square"></i> Edit Assign Meating</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item">Users</li>
                    <li class="breadcrumb-item active">Edit Assign Meating</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="col-lg-2">
        <nav>
            <ol class="breadcrumb">
                <li class="p-1"><a class="btn btn-danger btn-sm text-white" href="{{route('bde.show-assign-meeting')}}">
                ...
                <div class="card-body pt-2">
                    <div class="tab-content pt-2">
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <form method="post" action="{{route('bde.update-assign-meeting',['cltid'=>Crypt::encrypt($ashign_meating->id)])}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 pt-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="client_potential">
                                                ...
                                                <option @if(isset($ashign_meating->client_potential) && $ashign_meating->client_potential==$key) {{'selected'}} @endif value="{{$key}}">{{$row}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-12 pt-3">
                                        <div class="form-group">
                                            <label>Remark</label>
                                            <textarea name="remark" class="form-control">{{$ashign_meating->remark}}</textarea>
                                        </div>
                                    </div>
