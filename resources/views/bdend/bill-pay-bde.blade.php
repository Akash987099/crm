...
<div class="row">
    ...
    <div class="col-lg-5">
        <nav>
            <ol class="breadcrumb">
                <li><a class="btn btn-danger text-white add_payment" href="{{route('bde.view-bde-meeting')}}">
                        <i class="bi bi-arrow-left"></i> View Meetings
                    </a>
                </li>
                &nbsp;
                <li><a class="btn btn-danger text-white add_payment" href="{{route('bde.view-coldcall')}}">
                        <i class="bi bi-arrow-left"></i> View Cold Calls Meetings
                    </a>
                </li>
            </ol>
        </nav>
