...
<div class="row">
    <div class="col-lg-10">
        <div class="pagetitle">
            <h1><i class="bi bi-info-circle"></i> Cold Call Details</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">Cold Call Details</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="col-lg-2">
        <nav>
            <ol class="breadcrumb">
                <li><a class="btn btn-danger btn-sm text-white" href="{{route('bde.view-coldcall')}}">
                            ...
                            <div class="card-body">
                                ...
                                <div id="invoice-company-details" class="row">
                                        ...
                                        <div class="media">
                                            <div class="media-body lh-lg">
                                                <ul class="ml-2 px-0 list-unstyled">
                                                    <li class="h6"><b>Name - </b> @if(isset($meeting_data->client_name)) {{$meeting_data->client_name}} @endif </li>
                                                    <li class="h6"><b>Company - </b>@if(isset($meeting_data->company_name)) {{$meeting_data->company_name}} @endif</li>
                                                    <li class="h6"><b>Phone - </b>@if(isset($meeting_data->phone)) {{$meeting_data->phone}} @endif</li>
                                                    <li class="h6"><b>Email - </b>@if(isset($meeting_data->email)) {{$meeting_data->email}} @endif</li>
                                                    <li class="h6"><b>Address - </b>@if(isset($meeting_data->address)) {{$meeting_data->address}} @endif</li>
                                                    <li class="h6"><b>Remark - </b>@if(isset($meeting_data->remark)) {{$meeting_data->remark}} @endif</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12 text-center text-md-right">
                                        ...
                                        <p class="pb-3 h4"><b>@if(isset($meeting_data->created_date)) {{$meeting_data->created_date}} @endif</b></p>
                                        <p class="pb-3 h5"><b>Status : </b>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-12">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-responsive" cellspacing="0" style="font-size: 16px;">
                                                    <thead>
                                                        <tr>
                                                            <th>Payment Mode</th>
                                                            <th>Amount</th>
