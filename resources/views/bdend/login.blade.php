                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="#" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <img src="{{asset('public/assets/uploads/logo/'.$setting->site_logo)}}" alt="">
                                    @endif
                                    <span class="d-none d-lg-block">BDE @isset($setting->company_title) {{$setting->company_title}} @endisset</span>
                                </a>
                            </div><!-- End Logo -->
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="row g-3 needs-validation" method="post" action="{{url('bde/login')}}">
                                        @csrf
                                        <div class="col-12">
