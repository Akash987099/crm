...
<div class="row">
    ...
    <div class="col-lg-2">
        <nav>
            <ol class="breadcrumb">
                <li><a class="btn btn-danger btn-sm text-white" href="{{route('bde.view-bde-meeting')}}">
                                        ...
                                        <div class="media">
                                            <div class="media-body lh-lg">
                                                <ul class="ml-2 px-0 list-unstyled">
                                                    <li class="h5"><b>Name - </b> @if(isset($meeting_data->client_name)) {{$meeting_data->client_name}} @endif </li>
                                                    <li class="h5"><b>Company - </b>@if(isset($meeting_data->company_name)) {{$meeting_data->company_name}} @endif</li>
                                                    <li class="h5"><b>Phone - </b>@if(isset($meeting_data->phone)) {{$meeting_data->phone}} @endif</li>
                                                    <li class="h5"><b>Email - </b>@if(isset($meeting_data->email)) {{$meeting_data->email}} @endif</li>
                                                    <li class="h5"><b>Address - </b>@if(isset($meeting_data->address)) {{$meeting_data->address}} @endif</li>
                                                    <li class="h5"><b>Remark - </b>@if(isset($meeting_data->remark)) {{$meeting_data->remark}} @endif</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-12">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-responsive" cellspacing="0" style="font-size: 18px;">
                                                    <thead>
                                                        <tr>
                                                            <th>Payment Mode</th>
                                                            <th>Amount</th>
