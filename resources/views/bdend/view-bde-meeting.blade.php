...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-10">
            <h1><i class="bi bi-card-list"></i> All Meetings Attend</h1>
        </div>
        <div class="col-lg-2">
            <nav>
                <ol class="breadcrumb">
                    <li><a class="btn btn-danger btn-sm text-white" href="{{url('bde/archive-bde-meeting')}}"><i class="bi bi-archive"></i> Archive Client</a></li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><b>Custom Price (Balance) : ₹</b> <span class="balance"></span> </p>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var table = $('.dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('bde.view-bde-meeting') }}",
            dom: 'Blfrtip',
            buttons: [{
                    extend: 'pdf',
                    exportOptions: {
...

                {
                    ...
                    render: function(data, type, full, meta) {
                        if (data == 1) {
                            ...
                            return '<span class="badge rounded-pill bg-warning">Pandding</span>';
                        }
                    }
                },
                {
