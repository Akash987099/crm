...
<body>
    ...
    {{-- <footer class="footer bg-light py-2 text-center">
        <div class="container">
            <p class="mb-0">Copyright &copy; 2019 All Information used or mentioned in this application is copyrighted and Intellectual property of Logix Infosecurity Pvt Ltd.</p>
        </div>
    </footer> --}}
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="row g-3 needs-validation" method="post" action="{{route('employeeLogins')}}">
                                        @csrf
                                        <div class="col-12">
                                            <label class="form-label">Email</label>
                                            <div class="input-group has-validation">
                                                <span class="input-group-text" id="inputGroupPrepend">@</span>
                                                <input type="email" name="email" value="{{$logindata->email ?? ' '}}" class="form-control">
                                            </div>
                                            <div class="text-danger">@error('email') {{$message}} @enderror</div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <label class="form-label">Password</label>
                                            <input type="password" name="password" value="{{$logindata->show_password ?? ''}}" class="form-control">
                                            <div class="text-danger">@error('password') {{$message}} @enderror</div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
