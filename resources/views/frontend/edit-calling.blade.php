        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body pb-0 m-4">
                    ...
                    <form method="post" action="{{url('update-call')}}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group m-2">
                                    ...
                                    <input type="hidden" name="calid" value="{{Crypt::encrypt($edit_call->id)}}">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group m-2">
                                    ...
                                    <select class="form-select" name="status">
                                        <option {{($edit_call->status == 0)? 'selected':''}} value="0">Interested</option>
                                        <option {{($edit_call->status == 1)? 'selected':''}} value="1">Not Interested</option>
                                    </select>
