...
<div class="row">
    ...
    <div class="col-lg-3">
        <nav>
            <ol class="breadcrumb">
                <li class="p-1"><a class="btn btn-primary btn-sm text-white" href="{{route('manager.coldcall')}}">
                        <i class="bi bi-card-list"></i> Add Cold Call
                    </a>
                </li>
                <li class="p-1"><a class="btn btn-primary btn-sm text-white" href="{{route('manager.view-coldcall')}}">
...
<script>
    ...
    $(function() {
        ...
        var table = $('.dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('manager.archive-coldcall') }}",
