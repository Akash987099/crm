...
<div class="row">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Meeting Attend</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="col-lg-2">
        <nav>
            <ol class="breadcrumb">
                <li><a class="btn btn-danger btn-sm text-white" href="{{route('manager.massign-meeting')}}">
                ...
                <div class="card-body pt-2">
                    <div class="tab-content pt-2">
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <form method="post" action="{{route('manager.attend-meeeting',['cltid'=>Crypt::encrypt($ashign_meeting->id)])}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-4 pt-3">
                                        <div class="form-group">
                                            <label>Client Name <span class="text-danger">*</span></label>
                                            <input type="text" name="client_name" class="form-control" value="{{$ashign_meeting->client_name}}" placeholder="Enter name">
                                    ...
                                    <div class="col-lg-4 pt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_name" class="form-control" value="{{$ashign_meeting->company_name}}" placeholder="Enter company name">
                                    ...
                                    <div class="col-lg-4 pt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control" value="{{$ashign_meeting->email}}" placeholder="Enter email">
                                    ...
                                    <div class="col-lg-4 pt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone" class="form-control" value="{{$ashign_meeting->phone}}" placeholder="Enter phone">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="keywords" class="form-control" value="{{$ashign_meeting->keywords}}" placeholder="Enter category keyword">
                                    ...
                                    <div class="col-lg-4 pt-3">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input type="text" name="address" class="form-control" value="{{$ashign_meeting->address}}" placeholder="Enter address">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 pt-3">
                                        <div class="form-group">
                                            ...
                                            @php $client_potential = ['1'=>'Heigh','2'=>'Moderate','3'=>'Low']; @endphp
                                            <select class="form-control" name="client_potential">
                                                @if(!empty($client_potential))
                                                @foreach($client_potential as $key=>$row)
                                                <option @if(isset($ashign_meeting->client_potential) && $ashign_meeting->client_potential==$key) {{'selected'}} @endif value="{{$key}}">{{$row}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-4 pt-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control status" name="status">
                                                ...
                                                <option @if(isset($ashign_meeting->meeting_status) && $ashign_meeting->status==$key) {{'selected'}} @endif value="{{$key}}">{{$row}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-lg-12 pt-3">
                                        <div class="form-group">
                                            <label>Remark</label>
                                            <textarea name="remark" class="form-control">{{$ashign_meeting->remark}}</textarea>
                                        </div>
                                    </div>
...
<script>
    $(".services").change(function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('manager.select-service-getPrice')}}",
            data: {
                "_token": "{{ csrf_token() }}",
                "id": getId
            },
