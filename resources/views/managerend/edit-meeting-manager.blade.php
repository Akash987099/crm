        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Attend Meetings</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="card-body pt-2">
                    <div class="tab-content pt-2">
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            @endif
                            <div class="msg"></div>
                            <form method="post" action="{{route('manager.meeting-update',['meetingid'=>Crypt::encrypt($edit_meeting->id),'clientid'=>Crypt::encrypt($edit_meeting->clientid)])}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-4">
...
<script>
    $(document).ready(function() {
        ...
        $(".services").change(function() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('manager.meeting.select-service-getprice')}}",
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": getId
                },
