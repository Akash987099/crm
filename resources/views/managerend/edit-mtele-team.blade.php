...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-8">
            <h1><i class="bi bi-pencil-square"></i> Edit Telemarketing</h1>
        </div>
        <div class="col-lg-4">
            <nav>
                <ol class="breadcrumb">
                    <li class="p-1"><a class="btn btn-primary btn-sm text-white" href="{{url('manager/view-tele-team')}}"><i class="bi bi-list"></i> View Telemarketing</a></li>
                    <li class="p-1"><a class="btn btn-danger btn-sm text-white" href="{{url('manager/archive-mtele-team')}}"><i class="bi bi-archive"></i> Archive Telemarketing</a></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body pb-0 m-4">
                    ...
                    <form method="post" action="{{url('manager/edit-mtele-team')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
