...
<div class="pagetitle">
    <div class="row">
        ...
        <div class="col-lg-3">
            <nav>
                <ol class="breadcrumb">
                    {{-- <li class="p-1"><a class="btn btn-primary btn-sm text-white" href="{{route('adminagent')}}"><i class="bi bi-list"></i> View</a></li> --}}
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body pb-0 m-4">
                    ...
                    <form method="post" action="{{route('Mupdateagents')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group m-2">
                                    ...
                                    <input type="text" id="pincode" pincode="pincode" name="pincode" class="form-control" value="{{$agent->pincode}}" placeholder="Pincode">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group m-2">
                                    ...
                                    <input type="text" id="District" name="District" class="form-control" value="{{$agent->district}}" placeholder="District">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group m-2">
                                    ...
                                    <input type="text" name="State" id="State" class="form-control" value="{{$agent->state}}" placeholder="State">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group m-2">
                                    ...
                                    <input type="text" name="lead_source" class="form-control" value="{{$agent->lead_source}}" placeholder="Employee">
                                ...
                                <ul>
                                    @foreach($files as $file)
                                        <li>
                                            ...
                                            <a href="{{ asset("public/documents/{$agent->email}/{$file}") }}" target="_blank">
                                            <iframe src="{{ asset("public/documents/{$agent->email}/{$file}") }}" alt="{{ $file }}" frameborder="0" class="form-control"></iframe>
                                            </a>
                                                {{-- <img src="{{ asset("documents/{$agent->email}/{$file}") }}" alt="{{ $file }}" style="max-width: 100px;"> --}}
                                            @else
                                                <a href="{{ asset("public/documents/{$agent->email}/{$file}") }}" target="_blank">
                                                    {{ $file }}
                                                </a>
