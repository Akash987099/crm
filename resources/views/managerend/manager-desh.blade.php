                ...
                <div class="card-body pb-0">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a data-id="{{Crypt::encrypt($row->id)}}" class="text-primary meeting_id">
                                        {{$row->client_name}}
                                    </a>
                                </td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><b>Custom Price (Balance) :</b> <span class="blance"></span> </p>
                ...
                <p><b>Meeting Status :</b> <span class="status"></span> </p>
...
<script>
    $(document).on('click', '.meeting_id', function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('manager.recent-meeting-data')}}",
            data: {
                "_token": "{{ csrf_token() }}",
                "dataId": dataId
            },
