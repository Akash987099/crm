...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-10">
            <h1><i class="bi bi-check-circle-fill"></i> Cold Call Reports</h1>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body pb-0 m-4">
                    ...
                    <form method="post" action="{{route('manager.coldcall-reportGenerate')}}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4">
                    ...
                    <table class="table table-borderless datatable" cellspacing="0" width="100%">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-left"><b>@if(isset($number) && $number!="") {{$number}} @endif</b></td>
                                <td></td>
                                <td></td>
                            </tr>
                        </tfoot>
