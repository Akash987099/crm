                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="#" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <img src="{{asset('assets/uploads/logo/'.$setting->site_logo)}}" alt="">
                                    @endif
                                    <span class="d-none d-lg-block">MARKETING @isset($setting->company_title) {{$setting->company_title}} @endisset</span>
                                </a>
                            </div><!-- End Logo -->
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="row g-3 needs-validation" method="post" action="{{url('marketing/marketing-login')}}">
                                        @csrf
                                        <div class="col-12">
                            ...
                            <div class="copyright">
                                &copy; Copyright <strong><span>Magnum Digitalsolution</span></strong>
                            </div>
