...
<div class="row">
    ...
    <div class="col-lg-4">
        <nav>
            <ol class="breadcrumb">
                <li><a class="btn btn-danger text-white m-1" href="{{route('market.view-attend-meeting')}}"><i class="bi bi-arrow-left"></i> Attend Meetings</a></li>
                <li><a class="btn btn-danger text-white m-1" href="{{route('market.view-cold-call')}}"><i class="bi bi-arrow-left"></i> Cold Call</a></li>
            </ol>
        </nav>
    </div>
</div>
