                                ...
                                <tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$count++}}</td>
                                            @if ($file->is_folder)
                                            <td><a href="{{ route('manager_file_view', ['parentId' => $file->id]) }}">{{ $file->name }}</a></td>
                                        @else
                                        ...
                                        <td>
                                            <div class="d-inline-block">
                                                ...
                                                <a class="btn btn-danger btn-sm" href="{{ route('manager_file_view', ['id' => $file->staff_id]) }}">View</a>
                                            </div>
                                            <div class="d-inline-block">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('manager.createFolder') }}" method="POST">
                                            @csrf
...
$(document).ready(function() {
    $('#uploadFileForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('manager_file.uploadFile') }}",
